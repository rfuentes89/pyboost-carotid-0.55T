...
class BoostParams:
    ...
    rr: float = 0.8                      # nominal RR interval [s]
    ...
    tr: float = 7.14e-3                     # bSSFP TR [s]  ("RF Low SAR")
    te: float = tr/2                      # bSSFP TE [s]  (~TR/2)
    ...
    im_flip_angle: Tuple[float, float] = (100.0, 90.0)
    ...
    slice_thickness: float = 0.96e-3        # [m]
